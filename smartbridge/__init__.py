...
#   import smartbridge
#   smartbridge.set_stream_logger(__name__)
#   OR
#   smartbridge.set_file_logger(__name__, '/tmp/log')
...
# To enable either of these by default within Smartbridge, add the following
# at the top of a Smartbridge module:
#   import smartbridge
#   smartbridge.set_stream_logger(__name__)
#   OR
#   smartbridge.set_file_logger(__name__, '/tmp/log')
